  ...
  const series = [
    {
      ...
      data: [15, 18, 22, 27, 29, 32, 40, 45, 50, 55, 60, 65],
    },
    {
      name: "Solicitudes de Habitaciones",
      data: [10, 15, 20, 22, 30, 35, 38, 40, 45, 50, 55, 58],
    },
  ];
      ...
      <div className="flex flex-wrap items-start justify-between gap-3 sm:flex-nowrap">
        <div className="flex w-full flex-wrap gap-3 sm:gap-5">
          <div className="flex min-w-47.5">
            ...
            <div className="w-full">
              ...
              <p className="text-sm font-medium">01.2024 - 12.2024</p>
            </div>
          </div>
          <div className="flex min-w-47.5">
        ...
        <div className="flex w-full max-w-45 justify-end">
          <div className="inline-flex items-center rounded-md bg-whiter p-1.5 dark:bg-meta-4">
            <button className="rounded bg-white px-3 py-1 text-xs font-medium text-black shadow-card hover:bg-white hover:shadow-card dark:bg-dark dark:text-white dark:hover:bg-dark">
              Día
            </button>
